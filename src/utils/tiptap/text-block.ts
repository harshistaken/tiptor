...
// --- Utils ---
import { isNodeInSchema } from "./schema";
...
export const TextBlockIcons: Record<TextBlockType, React.ElementType> = {
    h1: Icons.MaterialHeading1,
    h2: Icons.MaterialHeading2,
    h3: Icons.MaterialHeading3,
    h4: Icons.MaterialHeading4,
    h5: Icons.MaterialHeading5,
    h6: Icons.MaterialHeading6,
    p: Icons.MaterialTitle,
};
